...
from satmut_utils.definitions import PROJECT_ROOT, PROJECT_LAB, PROJECT_AUTHOR, DEFAULT_MUT_SIG, DEFAULT_TEMPDIR
...
class VariantCaller(object):
    ...
    def workflow(self, min_bq=VARIANT_CALL_MIN_BQ, max_nm=VARIANT_CALL_MAX_NM,
        ...
        :raises NotImplementedError: if min_bq is 0 while primers are provided
        """
