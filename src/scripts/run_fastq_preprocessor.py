...
def parse_commandline_params(args):
    ...
    parser.add_argument("-5", "--r1_fiveprime_adapters", required=True, type=str,
                        help='Comma-delimited R1 5\' adapters.')

    parser.add_argument("-3", "--r1_threeprime_adapters", required=True, type=str,
...
def workflow(f1, f2, r1_fiveprime_adapters, r1_threeprime_adapters, outdir=FastqPreprocessor.OUTDIR,
    ...
    fqp = FastqPreprocessor(
        ...
        outdir=outdir, ncores=ncores, trim_bq=trim_bq, ntrimmed=ntrimmed, overlap_len=overlap_len, no_trim=False)
